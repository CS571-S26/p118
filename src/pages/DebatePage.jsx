...
export default function DebatePage({ debate, onBack }) {
  ...
  const { hotSeatConservative, hotSeatDemocrat } = useMemo(() => {
    ...
    const hotSeatConservative =
      commentsForDebate
        .filter((c) => c.leaning === "Conservative")
        .sort((a, b) => score(b) - score(a))[0] ?? null;

    const hotSeatDemocrat =
      commentsForDebate
        .filter((c) => c.leaning === "Democrat")
        .sort((a, b) => score(b) - score(a))[0] ?? null;
    ...
    <div className="app">
      ...
      <main className="debate-page">
        <div className="discussion-stack">
          ...
          {/* Composer above HotSeat + thread (your chosen layout) */}
          ...
          <div className="discussion-stack__hotseat">
            <HotSeatPanel
              commentConservative={hotSeatConservative}
              commentDemocrat={hotSeatDemocrat}
            />
          </div>
